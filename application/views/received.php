    ...
    <section id="main-content" style="padding:5px;">
      <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Orders Albums</h3>
          <div class="row mb">
            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info" width="100%" data-order="[[ 6, &quot;desc&quot; ]]">
                ...
                <tr>
                    ...
                    <th><?= $row->oQuantity ?></th>
                    <th><button data-toggle="tooltip" title="Received" class="btn btn-theme oStatus" value='{"albumId" :"<?= $row->albumId ?>","oStatus" :"2" }'>Received</button></th>
